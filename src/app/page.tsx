      ...
      <Container className="relative mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Fullstack developer, designer, and tech enthusiast.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Bilgekaan, a Fullstack developer and entrepreneur based in Bursa
            City from Türkiye. As a passionate full-stack developer, I combine
            ...
            development, I specialize in building dynamic web applications that
